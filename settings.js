...
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=CAdTxTIS#M9ydhGkB_LKlXGt-50RfGJQnz3BUKEG8zzvspES2EhE' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94772801923,94753335072" : process.env.MODERATORS ,    
MAX_SIZE: process.env.MAX_SIZE === undefined ? '1536': process.env.MAX_SIZE,/*add this in megabytes*/    
OWNER_NAME: process.env.OWNER_NAME || 'WHITE_TIGER' ,
